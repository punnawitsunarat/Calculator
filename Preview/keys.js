...
const rows=[
  ...
  [['file','FILE',null,'Prog "'],['sqrt','√','sqrt(',':',':'],['square','x²','^2','◢','"'],['log','log','log(','10^('],['ln','ln','ln(','e^('],['power','xⁿ','^','^(-1)']],
  [['i','i','i','∠','A'],['fraction','fraction','/','/','B'],['dms','°′″','dms(','dms(','C'],['sin','sin','sin(','asin(','D'],['cos','cos','cos(','acos(','E'],['tan','tan','tan(','atan(','F']],
